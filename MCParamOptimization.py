...
StockCloseData = yf.download(stock, start=historical_start_date, end=historical_end_date).loc[:, "Close"]
...
actual_prices_df = yf.download(stock, start=prediction_start, end=prediction_end)[['Close']]
